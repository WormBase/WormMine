...
'query_19': """<query model="genomic" view="Gene.primaryIdentifier Gene.symbol Gene.secondaryIdentifier Gene.organism.name" ><constraint path="Gene" op="IN" value="metrics_list_union" code="A" /></query>""",
